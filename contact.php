...
<body>
    <header>
       ...
       <a href="https://www.nsbm.ac.lk/" style="text-decoration: none; margin-left: 15px;">
                <img src="./image/NSBM Logo.png" alt="Second Logo" class="logo second-logo">
            </a>
        <nav>
  ...
  <div id="mainContent">
      ...
      <div class="text-section">
        ...
        <div class="icons-text-group">
          <div class="icon-text-row">
            ...
            <p class="normal">mathscircle@nsbm.ac.lk</p>
          </div>
          <div class="icon-text-row">
          ...
          <div class="icon-text-row">
            ...
            <p class="normal">Mathematics and Statistics Circle - NSBM</p>
          </div>
        </div>
      </div>
    ...
    <div class="DIVALL flex-container">
      ...
      <div class="team-member">
        <div class="master-incharge-wrapper">
          <img src="./image/mis.png" alt="Master Incharge" class="master-incharge" />
        </div>
      </div>
    </div>
    ...
    <div class="DIVALL">
      ...
      <form action="https://formspree.io/f/xanblvyr" method="POST" id="contactForm">
